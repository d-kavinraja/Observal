...
![Login page in local mode](images/login-local.png)
...
![Registry home page](images/registry-home.png)
...
![Agent list page](images/agents-list.png)
...
![Component list — MCPs tab](images/components-list.png)
...
![Agent builder with preview panel](images/agent-builder.png)
...
![Traces list page](images/traces.png)
...
![Eval page with config banner](images/eval-no-config.png)
...
![Review queue](images/review.png)
...
![Users page with role dropdowns](images/users.png)
...
![Settings page with system overview](images/settings.png)
